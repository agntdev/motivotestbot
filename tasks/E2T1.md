...
Implement the /quote command to fetch and send a random quote from the hardcoded list. Write tests to tests/specs/E2T1.json and append the command to tests/commands.json.
