# E3T2 — Send Daily Quotes

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MOTV

Implement the logic to query all subscribers and send a random quote to each at 09:00 UTC. Write tests to tests/specs/E3T2.json.

## Skills

**Skills:** telegram-bot-basics, postgres
