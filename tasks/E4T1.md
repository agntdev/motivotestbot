# E4T1 — Hardcoded Quotes Array

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MOTV

Implement a hardcoded array of ~40 motivational strings in src/quotes.ts. Export the array for use by commands and the scheduler.

## Skills

**Skills:** telegram-bot-basics, typescript
