# E5T1 — Dockerfile Implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MOTV

Create a Dockerfile to containerize the bot application. Ensure it includes all dependencies and runs the bot as a Node process.

## Skills

**Skills:** telegram-bot-basics, docker
