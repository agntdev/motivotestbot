# E1T1 — /subscribe Command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MOTV

Implement the /subscribe command to insert/upsert a subscriber row in the database. Write tests to tests/specs/E1T1.json and append the command to tests/commands.json.

## Skills

**Skills:** telegram-bot-basics, postgres, telegram-test-specs
