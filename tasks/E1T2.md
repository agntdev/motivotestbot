# E1T2 — /unsubscribe Command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 MOTV

Implement the /unsubscribe command to delete a subscriber row from the database. Write tests to tests/specs/E1T2.json and append the command to tests/commands.json.
